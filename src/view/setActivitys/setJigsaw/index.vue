          ...
          <el-tabs v-model="tabActiveId" type="card">
            <el-tab-pane label="样式设置" name="1">
              <div class="form_module">
                ...
                <el-form-item label="拼图图片" class="form_item_rankingprize">
                  <el-upload
                    class="avatar-uploader"
                    :action="upUrl"
                    :show-file-list="false"
                    ...
                    :before-upload="beforeAvatarUpload"
                  >
                    <img v-if="form.jigsaw_img" :src="form.jigsaw_img" class="avatar">
                    <i v-else class="el-icon-plus avatar-uploader-icon"></i>
                  </el-upload>
                </el-form-item>
            ...
            <el-tab-pane label="奖项设置" name="3">
              <div class="form_module">
                ...
                <el-form-item label="拼图数量"  class="inputs">
                  <el-input disabled value='16块' placeholder="16块" type="number"></el-input>
                </el-form-item>
                <el-form-item label="新用户奖励" prop="authorize_number" class="inputs">
                  <el-input v-model="form.authorize_number" placeholder="设置奖励" type="number"></el-input>
                  <span class="input_mes">(*必填)</span>
                </el-form-item>
                <el-form-item label="打开任务奖励" class="form_item_double inputs">
                  <div class="double_list">
                    <div class="double_item">
                      <el-input type="number" v-model="form.money_open.open_num" placeholder="次"></el-input>
                      <span class="icon_equal">~</span>
                      <el-input type="number" v-model="form.money_open.number" placeholder="块"></el-input>
                    </div>
                  </div>
                </el-form-item>
                <el-form-item label="邀请好友奖励" prop="invite_number" class="inputs">
                  <el-input v-model="form.invite_number" placeholder="设置邀请好友奖励" type="number"></el-input>
                  <span class="input_mes">(*必填)</span>
                </el-form-item>
                <el-form-item label="中奖积分范围" class="form_item_double inputs">
                  <div class="double_list">
                    <div class="double_item">
                      <el-input type="number" v-model="form.money1.min_money" placeholder="最小"></el-input>
                      <span class="icon_equal">~</span>
                      <el-input type="number" v-model="form.money1.max_money" placeholder="最大"></el-input>
                    </div>
                  </div>
                </el-form-item>
                <el-form-item label="未中奖积分范围" class="form_item_double inputs">
                  <div class="double_list">
                    <div class="double_item">
                      <el-input type="number" v-model="form.money2.min_money" placeholder="最小"></el-input>
                      <span class="icon_equal">~</span>
                      <el-input type="number" v-model="form.money2.max_money" placeholder="最大"></el-input>
                    </div>
                    <div class="double_item">
                      <el-input type="number" v-model="form.money3.min_money" placeholder="最小"></el-input>
                      <span class="icon_equal">~</span>
                      <el-input type="number" v-model="form.money3.max_money" placeholder="最大"></el-input>
                    </div>
                  </div>
                </el-form-item>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        authorize_number: [{  required: true, message: "请填写新用户奖励", trigger: "blur" }],
        invite_number: [{  required: true, message: "请填写邀请新用户奖励", trigger: "blur" }]
      },
      formDomData: {
        //form中模版数据
        activityTemArr: [
          {
            url: require("@/assets/images/setjag_tem1.png"),
            label: "模版一"
          }
          // {
  ...
  methods: {
    ...
    handleAvatarSuccess3(res, file) {
      ...
      this.form.jigsaw_img = res.data.path;
      console.log(this.form.jigsaw_img, res.data.path )
    },
