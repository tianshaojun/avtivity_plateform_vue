    ...
    <div class="content">
      ...
      <div class="tableBox">
        <el-table :data="tableData" border>
          ...
          <el-table-column prop="city" label="活动编号"></el-table-column>
          <el-table-column prop="address" label="提现金额"></el-table-column>
          <el-table-column prop="zip" label="审核时间"></el-table-column>
          <el-table-column prop="address" label="支付流水"></el-table-column>
        </el-table>
      </div>
      <div class="pagebox">
        <el-pagination
